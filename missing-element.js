...
{   
    ...
    firstPart = [ "Uzupełnij całą formę passé composé", "La princesse", "Nous", "Les enfants", "Tu", "Je", "Elles", "Le fournisseur", "Vous", "Ma sœur", "Les artistes contemporains", "Nous", "La petite fille", "Ils", "Tu", "J'" ];
    secondPart = [ "Wpisz pełną formę czasownika w passé composé", "(danser) toute la nuit au bal.", "(parler) avec notre fournisseur hier.", "(se tromper) d'heure pour la réunion.", "(habiter) près du château de la princesse ?", "(regarder) trois dessins animés ce weekend.", "(se déguiser) en personnages contemporains.", "(arriver) dans notre fuseau horaire.", "(protéger) votre peau du soleil ?", "(tomber) pendant la réunion.", "(créer) une œuvre magnifique.", "(s'adapter) au nouveau fuseau horaire.", "(dessiner) une princesse.", "(changer) de fournisseur le mois dernier.", "(se coucher) tard après le dessin animé ?", "(oublier) ma crème pour la peau." ];
    missingElement = [ "Passé composé", "a dansé", "avons parlé", "se sont trompés", "as habité", "ai regardé", "se sont déguisées", "est arrivé", "avez protégé", "est tombée", "ont créé", "nous sommes adaptés", "a dessiné", "ont changé", "t'es couché", "ai oublié" ];
    hints = [ "nan", "avoir", "avoir", "être", "avoir", "avoir", "être", "être", "avoir", "être", "avoir", "être", "avoir", "avoir", "être", "avoir" ];
